...
email,address,position_id,education_degree_id,division_id,username)
VALUES 
  (
...
id_card,phone_number,email,address,deleted)
values 
  (
...
values 
  ...
  (2, 'House'), 
  (3, 'Room');
insert into facility (id,name,area,cost,max_people,
rent_type_id,facility_type_id,standard_room,description_other_convenience,
pool_area,number_of_floors,facility_free, deleted)
values 
  (
...
insert into contract (id, start_date, end_date, deposit, employee_id, customer_id, facility_id,deleted) 
values 
  (
